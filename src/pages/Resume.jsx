    ...
    <section className="bg-[var(--primary)] min-h-screen px-[10vw] pt-20 md:pt-28 text-white ">
      <div className="bg-[var(--secondary)] rounded-xl overflow-hidden">
        ...
        <div className="p-8 flex flex-col items-center gap-5 ">
          ...
          <a  href="/Pratik_rathore_resume.pdf"  download className="flex gap-2 mt-2 items-center bg-gradient-to-r from-blue-600 to-blue-400 py-2 px-4 rounded-md"><LuDownload /> <p className="text-sm">Download Resume</p></a>
        </div>
      </div>
